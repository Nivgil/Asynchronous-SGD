...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, bn_momentum=0.1):
        ...
        self.bn1.weight.data.zero_().add_(1)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes, momentum=bn_momentum)
        self.bn2.weight.data.zero_().add_(1)
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, bn_momentum=0.1):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, bn_momentum))
...
class ResNet_imagenet(ResNet):
    ...
    def __init__(self, num_classes=1000,
                 block=Bottleneck, layers=[3, 4, 23, 3], bn_momentum=0.1):
