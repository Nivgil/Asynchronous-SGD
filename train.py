...
def get_model(mode, *args, **kwargs):
    return {'alexnet': alexnet, 'resnet18': torchvision.models.resnet18, 'resnet50': torchvision.models.resnet50}[mode](
        *args, **kwargs)
...
def main(args):
    ...
    if args.batch_size > 256 and args.dataset == 'imagenet' and args.model == 'resnet50':
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_loss, train_error = train(train_loader, model, criterion, server, epoch, args.workers_num, args.grad_clip,
                                        batch_accumulate_num, train_bar)
